...
//Promise метод all і він приймає масив з промісами
//Promise.all - перевіряє чи всі проміси виконались
//Promise.all - очікує завершення всіх промісів, а потім виконує
// викоувати можна через then  catch
Promise.all([test(1000),test(2000)]).then(() => {
 console.log('All');//All через 2 сек
});

// 2 метод race - навпаки
// задаємо декілька промісів і маємо оприділити який 1ший
// race- виконується коли 1й проміс правильно відпрацював
// all - коли всі проміси правильно відпрацювали( тобто останній)
